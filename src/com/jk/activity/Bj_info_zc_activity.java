...
public class Bj_info_zc_activity extends Activity implements
		...
		zcbc.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (!money.isEmpty()) {
					...
					Toast.makeText(Bj_info_zc_activity.this, "修改成功",
							Toast.LENGTH_LONG).show();

					finish();
				} else {
					Toast.makeText(Bj_info_zc_activity.this, "金额不能为空!",
							Toast.LENGTH_LONG).show();
				}
